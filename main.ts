...
/**
 * 迫りくるエネミーを避けながらネコ（かわいい）を集めていくゲーム！
 * 
 * ・HP表示を4に変更
 * 
 * ・上下左右のボタンを押したときプレイヤーがその方向へ歩くアニメーションを行うよう設定　
 * 
 * ・エネミーにぶつかった時、エネミーが攻撃モーションを行うよう設定
 * 
 * ・またその際に背景の色を変えるなどして分かりやすくした
 * 
 * ・スコアが10の倍数のときにポーション（回復アイテム）が出るよう設定
 * 
 * ・スコアが10の時にエネミーの速度上昇、20の時にプレイヤーを追従するエネミーを追加
 * 
 * ・BGMは「Megalovania」を入れました。　ぜひ、聞いてみてください。
 */
